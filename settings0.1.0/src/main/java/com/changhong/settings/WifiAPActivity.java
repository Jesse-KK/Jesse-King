...
//                finish();
            ...
            case R.id.btn_ap_cancel:
                finish();
                break;
            case R.id.button_wifiap_visibility:
                if (isPasswordVisible == false) {
                    etPwd.setTransformationMethod(HideReturnsTransformationMethod.getInstance());//显示密码
                    btnShow.setText("隐藏");
                    isPasswordVisible = true;
                } else {
                    etPwd.setTransformationMethod(PasswordTransformationMethod.getInstance());//隐藏密码
                    btnShow.setText("显示");
...
//                            flContainer.setVisibility(View.VISIBLE);
    ...
    private void initView() {
        ...
        btnShow=(Button)findViewById(R.id.button_wifiap_visibility);
        etPwd.setTransformationMethod(PasswordTransformationMethod.getInstance());//隐藏密码
...
//        Settings.Secure.putString(mContext.getContentResolver(),"wifiap_account",ssid);
//        Settings.Secure.putString(mContext.getContentResolver(),"wifiap_password",password);
        if (TextUtils.isEmpty(ssid)) {
            Log.i(TAG, "ssid null.");
