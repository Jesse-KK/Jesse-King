...
public class WifiAdminUtils {
    ...
    public int getIpAddress() {
        if (((mWifiInfo == null) ? 0 : mWifiInfo.getIpAddress()) == 0) {
            DhcpInfo dhcpInfo = mWifiManager.getDhcpInfo();

            return ((dhcpInfo == null) ? 0 : dhcpInfo.ipAddress);
        }else {
    ...
    public boolean connect(String SSID, String Password, WifiConnectUtils.WifiCipherType Type) {
        ...
        if (mConnectConfig) {
            Log.i("netsettingofethernet", "connect: save Configurtion !!!!!!!!!! ");
    ...
    public void forgetPsd(int networkId) {
        Log.i("cheng", "forgetPsd: ");
    ...
    public static boolean set_static(String SSID, String static_ip, String static_gateway, String static_dns) {
        ...
        if (tempConfig != null) {
            try {
                ...
                int netId = mWifiManager.updateNetwork(tempConfig);
                ...
                if (result) {
                    ...
                    boolean isEnabled = mWifiManager.enableNetwork(tempConfig.networkId, true);
