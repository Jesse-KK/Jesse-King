...
public class Network_PPPOE_Activity extends Activity implements View.OnClickListener {

    private final static String TAG = "PPPOE_Activity";
    ...
    private void init() {
        ...
        mContext = Network_PPPOE_Activity.this;
    ...
    private void initData() {
        Log.i(TAG, "initData: ");
        String username = SystemProperties.get("persist.sys.ch.pppoename", "");
        String password = SystemProperties.get("persist.sys.ch.pppoepwd", "");
        ...
        stack = SystemProperties.get("persist.sys.ch.set.stack", "unset");
...
//        password=mIpConfigV4.pppoePassword;
        ...
        SystemProperties.set("persist.sys.ch.pppoename", mUsername);
        SystemProperties.set("persist.sys.ch.pppoepwd", mPassword);
