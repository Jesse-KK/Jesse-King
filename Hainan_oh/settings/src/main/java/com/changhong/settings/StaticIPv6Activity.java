...
public class StaticIPv6Activity extends Activity implements View.OnClickListener {
    ...
    private void showIpv6Info() {
        ...
        if (sGateway.length == 3) {
            ...
            gateway_5.setText("");
            gateway_6.setText("");
            gateway_7.setText(sGateway[1]);
            gateway_8.setText(sGateway[2]);
        }
        if (sDns1.length == 3) {
            ...
            dns_5.setText("");
            dns_6.setText("");
            dns_7.setText(sDns1[1]);
            dns_8.setText(sDns1[2]);
        }
        if (sDns2.length == 3) {
            ...
            spare_dns5.setText("");
            spare_dns6.setText("");
            spare_dns7.setText(sDns2[1]);
            spare_dns8.setText(sDns2[2]);
        }
